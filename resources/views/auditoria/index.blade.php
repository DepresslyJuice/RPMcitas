    ...
    @section('content')
        {{-- Solo Administrador, Secretaria y Doctor pueden ver esta sección --}}
        @if (auth()->user()->hasRole('Administrador'))
                            ...
                            <select name="usuario" class="form-control">
                                ...
                                @foreach ($usuarios as $usuario)
                                    <option value="{{ $usuario }}"
                                        {{ request('usuario') == $usuario ? 'selected' : '' }}>
                                        Usuario #{{ $usuario }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <!-- Contenido visible para Administrador, Secretaria y Doctor -->
