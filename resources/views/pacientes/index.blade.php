...
@section('content')
    <div class="container">
        ...
        <form method="GET" action="{{ route('pacientes.index') }}">
            <input type="text" name="search" placeholder="Buscar paciente" class="form-search"
                    ...
                    @foreach ($pacientes as $paciente)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('pacientes.historial', $paciente->cedula) }}"
                                    class="btn btn-warning btn-sm">Ver Paciente</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
